...
def test_exclusive_policy_positive_examples_1(digraph, features_1d, labels_2d):
...
def test_exclusive_policy_positive_examples_2(digraph, features_1d, labels_2d):
    policy = ExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        True,
        False,
...
def test_exclusive_policy_positive_examples_3(digraph, features_1d, labels_2d):
    policy = ExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        False,
        False,
...
def test_exclusive_policy_negative_examples_1(digraph, features_1d, labels_2d):
    policy = ExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        True,
        True,
...
def test_exclusive_policy_negative_examples_2(digraph, features_1d, labels_2d):
    policy = ExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        False,
        True,
...
def test_exclusive_policy_negative_examples_3(digraph, features_1d, labels_2d):
    policy = ExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        True,
        True,
...
def test_less_exclusive_policy_negative_examples_1(digraph, features_1d, labels_2d):
...
def test_less_exclusive_policy_negative_examples_2(digraph, features_1d, labels_2d):
    policy = LessExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        True,
        True,
...
def test_less_exclusive_policy_negative_examples_3(digraph, features_1d, labels_2d):
    policy = LessExclusivePolicy(digraph, features_1d, labels_2d)
    ground_truth = [
        True,
        True,
